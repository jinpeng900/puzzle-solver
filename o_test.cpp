...
int main(int argc, char** argv) {
    ...
    std::vector<LevelConfig> levels = {
        {1, 73705, 10, "Level 1 (10x10, 纯5色)"},
        {2, 73705, 10, "Level 2 (10x10, 纯5色)"},
        {3, 73705, 10, "Level 3 (10x10, 万能块15%)"},
        {4, 73705, 10, "Level 4 (10x10, 炸弹10%)"},
        {5, 73705, 12, "Level 5 (12x12, 万能块15%+炸弹10%)"},
    };
    ...
    int target_level = 0;
    if(argc>2) target_level = std::atoi(argv[2]);

    for (const auto& lc : levels) {
        if(target_level!=0 && lc.level!=target_level) continue;
        g_cur_level = lc.level;
    ...
    if(target_level!=0) {
        std::cout << "\nLEVEL " << target_level << " SCORE: " << total_score << "\n";
    } else {
        std::cout << "\n========================================\n";
