    ...
    std::vector<std::pair<int,int>> solve(const Board& board) {
        ...
        switch(board.level) {
            ...
            case 3:
                ...
                break;
            case 4:
                cur_cache_limit_ = 80000; cur_keep1_ = 120;
                cur_keep2_ = 60; cur_keep3_ = 12;
                mxc_weight_ = 15.0; dq_weight_ = 0.8; bh_weight_ = 0.02;
                step3_dq_weight_ = 0.55; step3_bh_weight_ = 0.025;
                surv_mul_ = 1.0; cur_beam_w_ = 5; cur_beam_d_ = 3;
                break;
            case 5:
...
int main() {
    ...
    std::vector<LevelConfig> levels = {
        {1, SEED, 10, "Level 1 (10x10, 纯5色)"},
        {2, SEED, 10, "Level 2 (10x10, 纯5色)"},
        {3, SEED, 10, "Level 3 (10x10, 万能块15%)"},
        {4, SEED, 10, "Level 4 (10x10, 炸弹10%)"},
        {5, SEED, 12, "Level 5 (12x12, 万能块15%+炸弹10%)"},
    };
